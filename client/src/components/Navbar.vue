<template>
  <div class="mb-5">
    <b-navbar toggleable="lg"  id="bg-color">
        ...
        <b-navbar-nav>
          <router-link to="/products/add" id="link" >Add New Product</router-link>
        </b-navbar-nav>
        <b-navbar-nav>
          <router-link to="/products" id="link" class="ml-5">Products</router-link>
        </b-navbar-nav>
...
#link {
  ...
  background-image: linear-gradient(#222b40, #222b40),
    linear-gradient(rgb(176, 233, 251), rgb(176, 248, 251)),
    linear-gradient(#feeab2, #fdfeb2);
